...
OPENCLAW_IMAGE="${OPENCLAW_IMAGE:-openclaw-dev:latest}"
...
OPENCLAW_HOME_VOLUME_SIZE="${OPENCLAW_HOME_VOLUME_SIZE:-}"
OPENCLAW_DOCKER_VOLUME_SIZE="${OPENCLAW_DOCKER_VOLUME_SIZE:-}"
...
CONTAINER_HOME_VOLUME_SIZE="${OPENCLAW_HOME_VOLUME_SIZE}"
CONTAINER_DOCKER_VOLUME_SIZE="${OPENCLAW_DOCKER_VOLUME_SIZE}"
...
Environment:
  ...
  OPENCLAW_HOME_VOLUME_SIZE=${OPENCLAW_HOME_VOLUME_SIZE:-auto}
  OPENCLAW_DOCKER_VOLUME_SIZE=${OPENCLAW_DOCKER_VOLUME_SIZE:-auto}
...
Examples:
  ...
  OPENCLAW_NAME=openclaw-a ./images/openclaw/container.sh up
  OPENCLAW_NAME=openclaw-b OPENCLAW_MEMORY=12g OPENCLAW_CPUS=6 OPENCLAW_HOME_VOLUME_SIZE=50G OPENCLAW_DOCKER_VOLUME_SIZE=150G ./images/openclaw/container.sh up
  OPENCLAW_NAME=openclaw-b ./images/openclaw/container.sh destroy --purge
EOF
}
